...
//        teamsExpected.add(new CustomTeam(0l, "Real Madrid-Pro", formationOne, ((EndUser) userOne)));
...
//
//        List<Team> teamsExpected = new ArrayList<>();
//        teamsExpected.add(new CustomTeam(0l, "Real Madrid-Pro", formationRepository.get(1l), ((EndUser) userRepository.get(0l))));
//
//        // Assert
//        Assertions.assertEquals(teamsExpected, teams);
//
...
//        // Act
//
//        teamService.add(new CustomTeam(4l, "Test123", formationOne, ((EndUser) userTwo)));
//        List<Team> teams = teamService.getAll();
//
//        List<Team> teamsExpected = new ArrayList<>();
//        teamsExpected.add(new CustomTeam(0l, "Real Madrid-Pro", formationOne, ((EndUser) userOne)));
...
//        teamsExpected.add(new OfficialTeam(3l,  "Juventus", formationTwo, "Manager3"));
//
//        teamsExpected.add(new CustomTeam(4l, "Test123", formationOne, ((EndUser) userTwo)));
//
//        // Assert
//        Assertions.assertEquals(teamsExpected, teams);
//    }
